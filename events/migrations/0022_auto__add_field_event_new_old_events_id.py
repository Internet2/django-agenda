...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.new_old_events_id'
        db.add_column('events_event', 'new_old_events_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.new_old_events_id'
        db.delete_column('events_event', 'new_old_events_id')
    ...
    models = {
        ...
        'events.event': {
            ...
            'new_old_events_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'old_events_id': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
