...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.submitter'
        db.add_column('events_event', 'submitter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Event.time_zone'
        db.add_column('events_event', 'time_zone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.submitter'
        db.delete_column('events_event', 'submitter')

        # Deleting field 'Event.time_zone'
        db.delete_column('events_event', 'time_zone')
    ...
    models = {
        ...
        'events.event': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 30, 0, 0)'}),
