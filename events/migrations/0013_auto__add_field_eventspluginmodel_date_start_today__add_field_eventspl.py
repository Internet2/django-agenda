...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventsPluginModel.date_start_today'
        db.add_column('cmsplugin_eventspluginmodel', 'date_start_today',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EventsPluginModel.date_end_yesterday'
        db.add_column('cmsplugin_eventspluginmodel', 'date_end_yesterday',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventsPluginModel.date_start_today'
        db.delete_column('cmsplugin_eventspluginmodel', 'date_start_today')

        # Deleting field 'EventsPluginModel.date_end_yesterday'
        db.delete_column('cmsplugin_eventspluginmodel', 'date_end_yesterday')
    ...
    models = {
        ...
        'events.event': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 0, 0)'}),
