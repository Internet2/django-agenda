...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sites', '0001_initial'),
        ('taggit', '0002_auto_20150213_1239'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
        ('cms', '0004_auto_20150213_1202'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publish_date', models.DateTimeField(default=datetime.datetime(2015, 2, 16, 9, 17, 4, 768141), verbose_name='publication date')),
                ...
                ('calendar', models.ForeignKey(related_name=b'events', blank=True, to='events.Calendar', null=True)),
                ('sites', models.ManyToManyField(to='sites.Site')),
                ('tags', models.ManyToManyField(to='taggit.Tag', blank=True)),
            ],
            options={
