...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventsPluginModel.old_tags'
        db.delete_column('cmsplugin_eventspluginmodel', 'old_tags')


    def backwards(self, orm):
        # Adding field 'EventsPluginModel.old_tags'
        db.add_column('cmsplugin_eventspluginmodel', 'old_tags',
