...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        ...
        for plugin in orm['events.eventspluginmodel'].objects.all():
            tags = map(lambda x: x.name, plugin.tags.all())
            plugin.old_tags = ",".join(tags)
    ...
    models = {
        ...
        'events.eventspluginmodel': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['taggit.Tag']", 'db_table': "'events_eventspluginmodel_tags'",'symmetrical': 'False', 'blank': 'True'})
        },
        'sites.site': {
        ...
        'tagfilters.tagfamily': {
            'Meta': {'ordering': "('name',)", 'object_name': 'TagFamily'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['tagfilters', 'events']
    symmetrical = True
