...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventsPluginModel.use_page_tags'
        db.add_column('cmsplugin_eventspluginmodel', 'use_page_tags',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventsPluginModel.use_page_tags'
        db.delete_column('cmsplugin_eventspluginmodel', 'use_page_tags')
    ...
    models = {
        ...
        'events.event': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 30, 0, 0)'}),
