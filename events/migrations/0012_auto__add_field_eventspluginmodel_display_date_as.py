...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventsPluginModel.display_date_as'
        db.add_column('cmsplugin_eventspluginmodel', 'display_date_as',
                      self.gf('django.db.models.fields.CharField')(default='descending', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventsPluginModel.display_date_as'
        db.delete_column('cmsplugin_eventspluginmodel', 'display_date_as')
