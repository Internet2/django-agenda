...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventsPluginModel.more'
        db.add_column('cmsplugin_eventspluginmodel', 'more',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EventsPluginModel.more'
        db.delete_column('cmsplugin_eventspluginmodel', 'more')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'events.event': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)'}),
