...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventsPluginModel.date_start'
        db.add_column('cmsplugin_eventspluginmodel', 'date_start',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventsPluginModel.date_end'
        db.add_column('cmsplugin_eventspluginmodel', 'date_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventsPluginModel.date_start'
        db.delete_column('cmsplugin_eventspluginmodel', 'date_start')

        # Deleting field 'EventsPluginModel.date_end'
        db.delete_column('cmsplugin_eventspluginmodel', 'date_end')
