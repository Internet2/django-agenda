...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tags on 'EventsPluginModel'
        db.create_table('events_eventspluginmodel_tags', (
        ...
        db.create_unique('events_eventspluginmodel_tags', ['eventspluginmodel_id', 'tag_id'])


    def backwards(self, orm):
        # Removing M2M table for field tags on 'EventsPluginModel'
        db.delete_table('events_eventspluginmodel_tags')
    ...
    models = {
        ...
        'events.event': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 0, 0)'}),
        ...
        'events.eventspluginmodel': {
            ...
            'old_tags': ('django.db.models.fields.CharField', [], {'max_length': '240', 'blank': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['taggit.Tag']", 'symmetrical': 'False', 'blank': 'True'})
        },
        'sites.site': {
