...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.old_events_id'
        db.delete_column('events_event', 'old_events_id')
        db.rename_column('events_event', 'new_old_events_id', 'old_events_id')

    def backwards(self, orm):
        # Adding field 'Event.old_events_id'
        db.rename_column('events_event', 'old_events_id', 'new_old_events_id')
        db.add_column('events_event', 'old_events_id',
    ...
    models = {
        ...
        'events.event': {
            ...
            'old_events_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
